...
namespace Bank.Balance.Api.External.ServiceBusReceive
{
    public class ServiceBusReceiveService : BackgroundService
    {
        ...
        {
            _logger.LogInformation("(Balance) Service Bus Receive Service is starting.");
        ...
        {
            _logger.LogInformation($"(Balance) Message received from subscription: {subscription}");
        ...
        {
            _logger.LogError(args.Exception, $"(Balance) Error processing message: {args.Exception.Message}");
            return Task.CompletedTask;
        }

        public override async Task StopAsync(CancellationToken cancellationToken)
        {
            _logger.LogInformation("(Balance) Service Bus Receive Service is stopping.");
        ...
        {
            _logger.LogInformation("(Balance) Service Bus Receive Service is disposing.");
